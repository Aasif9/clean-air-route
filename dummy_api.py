...
def initialize_system():
    ...
    print("Initializing Kolkata AQI Routing System with Dummy Data...")
    ...
    # Initialize with dummy AQI data
    ...
    print(f"Using {station_info['total_stations']} dummy AQI stations")
...
@app.route('/')
def home():
    return "Kolkata AQI Routing - Dummy Data Version"
 
@app.route('/stations')
def get_stations():
    """Get all dummy AQI stations"""
    if not interpolator:
...
if __name__ == '__main__':
    if initialize_system():
        print("Starting dummy data API server on http://localhost:5002")
